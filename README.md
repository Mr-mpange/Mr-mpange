...
### 🔹 Languages
C · C++ · Python · Java · JavaScript · PHP · TypeScript

### 🔹 Frontend
HTML · CSS · Bootstrap · React · Vue

### 🔹 Backend
Laravel · Django · Flask · Express · Spring · Node.js

### 🔹 Databases
MySQL · PostgreSQL · MongoDB · SQLite · SQL Server

### 🔹 Tools & Platforms
Git · Linux · Docker (Beginner) · Postman · Jupyter

<p align="left">
  <img src="https://skillicons.dev/icons?i=c,cpp,py,java,js,php,ts,html,css,bootstrap,react,vue,laravel,django,flask,nodejs,spring,mysql,postgres,mongodb,sqlite,git,linux,postman" />
</p>
